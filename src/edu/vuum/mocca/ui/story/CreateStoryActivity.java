...
public class CreateStoryActivity extends StoryActivityBase {
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    setTitleColor(getResources().getColor(R.color.darkgray));
	    setTitle("Create");
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		switch (item.getItemId()) {
	        case android.R.id.home:
	        	fragment.doCreateButtonClick();
	            return true;
	        case R.id.action_clear:
	        	fragment.doClearButtonClick();
	            return true;
	        case R.id.action_cancel:
	        	fragment.doCancelButtonClick();
	            return true;
	    }
	...
	private void launchSoundIntent() {
		...
		Intent i = new Intent(this, SoundRecordActivity.class);
		...
		i.putExtra(SoundRecordActivity.EXTRA_OUTPUT, file.getAbsolutePath());
